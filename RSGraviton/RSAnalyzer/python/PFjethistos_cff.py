...
# PF Jet ID
     cms.PSet(
        ...
        description = cms.untracked.string('jet_%d_chf'),
        plotquantity = cms.untracked.string('chargedHadronEnergyFraction'),
        min = cms.untracked.double(0.0),
        max = cms.untracked.double(1.0),
        itemsToPlot = cms.untracked.int32(4),
        name = cms.untracked.string('jet_%d_chf')
        ),
     cms.PSet(
        nbins = cms.untracked.int32(20),
        description = cms.untracked.string('jet_%d_nhf'),
        plotquantity = cms.untracked.string('neutralHadronEnergyFraction'),
        min = cms.untracked.double(0.0),
        max = cms.untracked.double(1.0),
        itemsToPlot = cms.untracked.int32(4),
        name = cms.untracked.string('jet_%d_nhf')
        ),
     cms.PSet(
        nbins = cms.untracked.int32(20),
        description = cms.untracked.string('jet_%d_cef'),
        plotquantity = cms.untracked.string('chargedEmEnergyFraction'),
        min = cms.untracked.double(0.0),
        max = cms.untracked.double(1.0),
        itemsToPlot = cms.untracked.int32(4),
        name = cms.untracked.string('jet_%d_cef')
        ),
     cms.PSet(
        nbins = cms.untracked.int32(120),
        description = cms.untracked.string('jet_%d_nef'),
        plotquantity = cms.untracked.string('neutralEmEnergyFraction'),
        min = cms.untracked.double(0.0),
        max = cms.untracked.double(1.0),
        itemsToPlot = cms.untracked.int32(4),
        name = cms.untracked.string('jet_%d_cef')
