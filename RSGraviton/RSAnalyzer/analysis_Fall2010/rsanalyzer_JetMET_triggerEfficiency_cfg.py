...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string('triggerTest_HLT65Jet50.root')
                                   )
...
process.triggerSelection = cms.EDFilter("TriggerResultsFilter",
                                        triggerConditions = cms.vstring('HLT_MET65 AND HLT_Jet50U',
                                                                        ),
...
process.plotMETNoTrigger = cms.EDAnalyzer("CandViewHistoAnalyzer",
                                          src = cms.InputTag("corMetGlobalMuons"),
                                          histograms = METhistos
                                          )

process.plotMETYesTrigger = cms.EDAnalyzer("CandViewHistoAnalyzer",
                                           src = cms.InputTag("corMetGlobalMuons"),
                                           histograms = METhistos
                                           )
...
process.pathNoTrigger = cms.Path(process.plotMETNoTrigger +
                                 process.triggerSelection +
                                 process.plotMETYesTrigger)
