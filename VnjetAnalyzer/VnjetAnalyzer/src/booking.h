...
const double maxptboson = 3500.;
const double minptjet = 0.;
const double maxptjet = 7000.;
const double minptlepton = 0.;
const double maxptlepton = 7000.;
const int numbinsboson = 700;
const int numbinsjet = 1400;
const int numbinslepton = 1400; 
...
H_tnumJets    = new TH1D( "jets_num", "Total number of jets", 10, -0.5, 9.5 );
...
H_tnumMuons   = new TH1D( "mu_num", "Total number of muons", 3, -0.5, 2.5);
...
H_ptnu_direct = new TH1D( "nu_pt_true", "Pt dist. nu - true", numbinslepton, minptlepton, maxptlepton);
H_pt_met      = new TH1D( "met_pt", "Pt dist - MET", numbinslepton, minptlepton, maxptlepton);
